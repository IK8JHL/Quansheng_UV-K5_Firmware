...
rem mod_piotr022_rssi_sbar.py temp\fw.dec.bin
    mod_piotr022_rssi_printer.py temp\fw.dec.bin
...
rem python mod_roger_mototrbo_like.py temp\fw.dec.bin
    ...
    python mod_roger_tone_edit.py temp\fw.dec.bin

:: end of mods

@echo Repacking firmware...
python qsfirm.py pack temp\fw.dec.bin temp\fw.ver.bin k5_v2.01.26_IK8JHL.bin
